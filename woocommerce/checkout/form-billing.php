...
<div class="woocommerce-delivery-option">
	...
	<!-- <div class="delivery-option"> 
		<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
			<input type="checkbox" name="delivery_option" checked value="delivery" class="woocommerce-form__input woocommerce-form__input-checkbox" data-type="delivery"> 
	...
	<div class="delivery-option">
		<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
			<input type="checkbox" name="delivery_option" value="self-collection" class="woocommerce-form__input woocommerce-form__input-checkbox"  data-type="self-collection"> 
			<span><?php //esc_html_e( 'Local pickup', 'woocommerce' ); ?></span>
		</label>
	</div> -->
</div>
